...
```sh
./tests/run.sh                          # all six projects, 7126 assertions
...
`designer` **365**, against **2591** for the whole project — measured at 3.7 s,
...
against 4053 in about eight. It can select because these tests are
