...
```sh
./tests/run.sh                          # all five projects, 6264 assertions
...
in a fifth of a second against 3518 in about eight. It can select because these tests are
