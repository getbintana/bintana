...
```sh
./tests/run.sh                          # all five projects, 6719 assertions
...
in a fifth of a second against 3911 in about eight. It can select because these tests are
...
44 events as this is written, plus 11 class statics, 249 on the globals and 60
