...
```sh
./tests/run.sh                          # all five projects, 6411 assertions
...
in a fifth of a second against 3665 in about eight. It can select because these tests are
