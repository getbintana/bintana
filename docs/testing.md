...
```sh
./tests/run.sh                          # all five projects, 6172 assertions
...
against 1815 in about 45, and `designer` is 351 in 4 s. Iterating on an early phase
