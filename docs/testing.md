...
```sh
./tests/run.sh                          # all five projects, 6614 assertions
...
in a fifth of a second against 3833 in about eight. It can select because these tests are
