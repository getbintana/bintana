...
```sh
./tests/run.sh                          # all five projects, 5513 assertions
...
`tests/ide` is thirty-two **phases**, each a generator with a scope of its own,
