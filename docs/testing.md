...
```sh
./tests/run.sh                          # all five projects, 6532 assertions
...
in a fifth of a second against 3751 in about eight. It can select because these tests are
