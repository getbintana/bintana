...
```sh
HEADLESS=1 ./tests/run.sh               # all four projects, 4917 assertions
...
against 1799 in about 45, and `designer` is 351 in 4 s. Iterating on an early phase
...
in a fifth of a second against 2966 in about three. It can select because these tests are
