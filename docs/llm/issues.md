...
| A drop target hears nothing until the drop itself — no enter, no move, no leave — so nothing can show where a dragged thing would land | [ISSUE-drag-feedback](../issues/ISSUE-drag-feedback.md) |
