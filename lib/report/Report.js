 ...
 * ## What it does not do
 *
 * **No printer.** `SavePdf` writes the document as a file and `Save` writes one
 * page as a PNG; choosing a printer, a tray and a number of copies is
 * `docs/issues/ISSUE-printing.md`, which is still open.
