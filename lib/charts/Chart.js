...
class Chart extends Component {
     ...
     * `--strict` (`docs/strict-plan.md`): a field a chart only creates on the
     * frame it first draws, or on the first time a pointer crosses it, is an
     * attempt to add a name to a sealed object and throws there.
     *
    ...
    _range; _reduction; bars; slices; lastBox; drawn; frames;
