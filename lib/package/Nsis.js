...
class Nsis {
     ...
     * the real compiler, `Include`, `Contrib` with the Modern UI, the stubs,
     * `COPYING`) -- so building an installer needs nothing installed; a tree without one falls back to a
