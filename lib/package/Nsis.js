...
class Nsis {
     ...
     * official NSIS distribution `makensis` needs beside itself (`Include`,
     * the stubs, `COPYING`) -- so building an installer needs nothing
     * installed; a tree without one falls back to a `makensis` on the PATH,
     * and neither is the sentence below.
     */
    static makensis() {
